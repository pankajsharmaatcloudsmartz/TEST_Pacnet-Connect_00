...
<%
ThemeDisplay thDisplay = (ThemeDisplay) request.getAttribute(WebKeys.THEME_DISPLAY);
%>

<%System.out.println("---"+thDisplay.getPathThemeCss()); %>

<link rel="stylesheet" type="text/css"
	href="<%=thDisplay.getPathThemeCss()%>/bootstrap.css" media="screen" />
<link rel="stylesheet" type="text/css"
	href="<%=thDisplay.getPathThemeCss()%>/bootstrap-responsive.css" media="screen" />
	...
	<script type="text/javascript">
			...
			/*@cc_on
			  ...
			  @if (@_jscript_version  < 9)
				  $('#isIESupported').css("display","block");
				  $('#ieSpanVesion').html(ieVersion);
			@end
			 @*/
			 });
		</script>
...
<div id="isIESupported" style='display:none;'>
				<center>
				<div class="alert alert-error" id="msg" style="display: block;"> 
					<button type="button" class="close" data-dismiss="alert">&times;</button>
				 <div id="alertMsg">
					Pacnet Connect has detected that you are currently using old version of Internet Explorer browser. Please upgrade your browser for better experience. Pacnet Connect is best viewed in the Internet Explorer version 9,10, etc..
				</div>
				</div>
				</center>
...
<div class="container custom-container only-Login-page">
			<div class="div_img fl">				
				<a href="<%=themeDisplay.getURLPortal()+""+request.getContextPath()%>introduction/index.html" media="screen" target="_blank" >
					<img src="${themeDisplay.pathThemeImages}/pacnet/image.jpg">
				</a>
			</div>


		<aui:form action="<%= loginURL %>" autocomplete='<%= PropsValues.COMPANY_SECURITY_LOGIN_FORM_AUTOCOMPLETE ? "on" : "off" %>' method="post" name="fm" cssClass="login_area fr">
...
<!--mid part start-->
				...
				<div class="">
					<p class="signin-txt">Sign In</p>
					<p class="hidden-phone">*Password is case sensitive</p>
					<label>
...
//var login = $(".only-Login-page").height();  
//alert($("#head-bg").height());

$(".only-Login-page").css("paddingTop", "30px");
